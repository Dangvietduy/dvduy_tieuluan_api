...
CREATE TABLE `accounts_roles` (
  ...
  KEY `role_id` (`role_id`),
  CONSTRAINT `accounts_roles_ibfk_1` FOREIGN KEY (`account_id`) REFERENCES `account` (`id`),
  CONSTRAINT `accounts_roles_ibfk_2` FOREIGN KEY (`role_id`) REFERENCES `role` (`id`)
...
INSERT INTO `accounts_roles` VALUES (1,1,1,0),(2,2,2,0),(3,3,3,0),(25,25,3,0);
